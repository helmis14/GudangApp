...
// Mengambil parameter dari GET atau POST
...
if (!empty($start_date) && !empty($end_date)) {
    $conditions[] = "m.tanggal BETWEEN '$start_date' AND '$end_date'";
}

if (!empty($search)) {
    $conditions[] = "(s.namabarang LIKE '%$search%' 
...
$query .= " ORDER BY m.tanggal DESC LIMIT 100";

$ambilsemuadatamasuk = mysqli_query($conn, $query);

if (!$ambilsemuadatamasuk) {
