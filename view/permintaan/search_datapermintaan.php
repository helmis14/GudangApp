...
if ($search !== '') {
    $query .= " WHERE permintaan.idpermintaan IN (
                    SELECT permintaan.idpermintaan 
                    FROM permintaan
                    INNER JOIN barang_permintaan ON permintaan.idpermintaan = barang_permintaan.idpermintaan
                    WHERE barang_permintaan.namabarang LIKE '%$search%'
                       OR permintaan.tanggal LIKE '%$search%'
                       OR barang_permintaan.keterangan LIKE '%$search%'
                )";
}

$query .= " GROUP BY permintaan.idpermintaan ORDER BY permintaan.idpermintaan DESC";
...
?>
        <tr>
            ...
            <td>
                <?php
                $detail_barang = explode(",", $detail_barang);
            ...
            <td>
                <?php
                $qtypermintaan = explode(",", $qtypermintaan);
